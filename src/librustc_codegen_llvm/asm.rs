...
fn reg_to_llvm(reg: InlineAsmRegOrRegClass) -> String {
    match reg {
        ...
        InlineAsmRegOrRegClass::RegClass(reg) => match reg {
            ...
            InlineAsmRegClass::DPU(DpuInlineAsmRegClass::reg32) => "r",
            InlineAsmRegClass::DPU(DpuInlineAsmRegClass::reg64) => "d",
...
fn dummy_output_type(cx: &CodegenCx<'ll, 'tcx>, reg: InlineAsmRegClass) -> &'ll Type {
    match reg {
        ...
        InlineAsmRegClass::DPU(DpuInlineAsmRegClass::reg32) => cx.type_i32(),
        InlineAsmRegClass::DPU(DpuInlineAsmRegClass::reg64) => cx.type_i64(),
